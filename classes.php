...
class Region {
  ...
  private $states = array(
    ...
    'TX-South Central' => explode(', ', '210, 214, 254, 325, 430, 432, 469, 512, 682, 737, 806, 817, 830, 903, 915, 940, 956, 972'),
    ...
    'AL' => explode(', ', '256, 938'),
    'FL-Gulf Coast' => explode(', ', '386, 850'),
    'LA' => explode(', ', '225, 337, 504, 985, 318'),
    'MS' => explode(', ', '228, 601, 662, 769'),
    'TX-Gulf Coast' => explode(', ', '281, 346 361, 409, 713, 832, 936, 979'),
    ...
    'FL-Florida' => explode(', ', '239, 305, 321, 352, 407, 561, 727, 754, 772, 786, 813, 863, 904, 941, 954'),
    'Puerto Rico' => explode(', ', '939, 787')
  );
  private $regions = array(
    'West Coast' => array('CA', 'AZ', 'AS', 'HI', 'NV', 'NP', 'NM', 'UT'),
    'Northwest' => array('OR', 'WA', 'AK', 'ID', 'MT'),
    'Mountain' => array('CO', 'WY', 'ID', 'MT', 'ND', 'SD', 'NE', 'MN', 'IA'), #TODO: ID & MT are duplicated in Northwest
    'South Central' => array('TX-South Central', 'AZ', 'OK', 'KS', 'Mexico', 'Canada'),
    'Gulf Coast' => array('AL', 'FL-Gulf Coast', 'LA', 'MS', 'TX-Gulf Coast'),
    'North Central' => array(),
    'North East' => array('OH', 'VA', 'WV', 'MI', 'MD', 'DE', 'NJ', 'PA', 'NY', 'CT', 'MA', 'RI', 'VT', 'NH', 'ME', 'DC', 'WI'),
    'South East' => array('TN', 'NC', 'SC', 'GA', 'IL', 'IN', 'KY', 'MO', 'VI', 'The Dominican Republic'),
    'Florida' => array('FL-Florida', 'Puerto Rico')
  );
  private $phone_numbers = array(
    '661-588-7337' => array('West Coast'),
    '503-564-0955' => array('Northwest'),
    '303-997-1397' => array('Mountain'),
    '254-771-3798' => array('South Central'),
    '713-481-5500' => array('Gulf Coast'),
    '724-342-6501' => array('North East'),
    '864-228-4826' => array('South East'),
    '305-396-3679' => array('Florida'),
  );
